...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareCarWithLessThan30MinParkingTime(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  30 * 60 * 1000) );//30 minutes parking time and less should give 0 parking fare
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
    ...
    @Test
    public void calculateFareCarReccurentClientReduction(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  60 * 60 * 1000) );
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
        ...
        // Insertion du ticket pour flager le client comme reccurrent
        TicketDAO tdao = new TicketDAO();
         tdao.saveTicket(ticket);
         tdao.saveTicket(ticket);
         tdao.saveTicket(ticket);
    ...
    @Test
    public void calculateFareBikeReccurentClientReduction(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  60 * 60 * 1000) );
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE,false);
